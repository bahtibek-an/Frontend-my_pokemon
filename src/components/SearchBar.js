  ...
  function filterSearch() {
    ...
    props.fullPokemonList.map((pokemon) => {
      if (pokemon.name.length > searchInput.length) {
        ...
        if (pokemonNameSubstring === searchInput) filteredResults.push(pokemon);
      }
    });
  ...
  return (
    <div className="searchBar flex my-4">
      ...
      <button
        ...
        className="searchBar__button flex grow-none font-medium bg-blue-100 hover:bg-blue-300 text-blue-600 p-2 rounded-md shadow-lg"
      >
